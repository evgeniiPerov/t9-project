...
export default function NotFound({ params }: { params: { lang: AvailableLocales } }) {
    return (
        <div className={'flex flex-col justify-center items-center gap-4 h-[calc(100dvh-300px)]'}>
            <p className={'text-center text-7xl font-thin tracking-widest'}>{locale[params.lang]?.error404}</p>
            <h1 className={'uppercase text-white text-center text-3xl font-light tracking-widest'}>
                {locale[params.lang]?.notFoundTitle}
            </h1>
